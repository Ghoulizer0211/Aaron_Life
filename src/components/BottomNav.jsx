  ...
  return (
    <nav className="bottom-nav">
      ...
      <div className="nav-brand">
        <span className="brand-name">Aaron's Life</span>
      ...
      <div className="nav-items">
        {TABS.map((tab) => (
          ...
          >
            <span className="nav-icon" style={{ color: tab.iconColor }}>{tab.icon}</span>
      ...
      <button className="nav-refresh" onClick={() => window.location.reload()} aria-label="Refresh">
